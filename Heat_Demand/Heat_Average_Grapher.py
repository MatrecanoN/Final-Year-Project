...
plt.ylabel("Heat Demand as Percentage of Annual Total (%)", fontsize=18)
plt.title("Min/Max and Average Heat Demand as a Percentage of Annual Total", fontsize=20)
...
legend = ["Average recorded generation"]
plt.xticks(ticks, fontsize=15)
plt.yticks()
plt.xlabel("Date", fontsize=20)
plt.ylabel("Heat Demand as Percentage of Annual Total (%)", fontsize=18)
plt.title("Min/Max and Average Heat Demand as a Percentage of Annual Total - Leap Year", fontsize=20)
